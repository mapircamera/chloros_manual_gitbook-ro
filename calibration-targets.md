...
Privind graficul de reflexie, puteți observa că valorile sunt lungimea de undă (axa x) versus procentul de reflexie (axa y). Când capturăm o imagine a țintei de calibrare, creăm o relație între valoarea pixelului și procentul de reflexie, în spectrul la care sunt sensibile fiecare dintre benzile senzorului camerei.
