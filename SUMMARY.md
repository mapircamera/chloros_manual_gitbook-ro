...
* [Interfața grafică: Navigare](navigation.md)
* [Interfața grafică: Proiecte](projects.md)
* [CLI : Linia de comandă](CLI.md)
* [API : Python SDK](api-python-sdk.md)
* [Camere compatibile](supported-cameras.md)
...
* [Adăugarea fișierelor într-un proiect](processing-images-gui/adding-files-to-a-project.md)
...
* [Formule indici multispectrali](project-settings/multispectral-index-formulas.md)
...
* [Sandbox indici/LUT](image-viewer-gui/index-lut-sandbox.md)
* [Marcaje hartă](image-viewer-gui/map-markers.md)

## Linux și Edge Computing

* [Prezentare generală Linux](linux/linux-overview.md)
* [Instalarea Linux](linux/linux-installation.md)
* [Ghid NVIDIA Jetson](linux/nvidia-jetson-guide.md)

## Arhitectura de procesare

* [Adaptare dinamică a calculului](processing-architecture/dynamic-compute-adaptation.md)
* [Conductă de procesare](processing-architecture/processing-pipeline.md)
